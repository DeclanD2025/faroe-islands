// =============================================================================
// DayFiveDetail — "Homeward" page.
// Bus to airport, flight to Gatwick, self-transfer to Stansted, Glasgow.
// =============================================================================
...
const DAY_FIVE_TIMELINE = [
  {
    num: 1,
    title: "Bus 300 · Hugo → Vágar Airport",
    subtitle: "2 Bakkavegur → Vágar Airport terminal",
    middleLabel: "Depart",
    middleValue: "07:40",
    rightLabel: "Arrive",
    rightValue: "07:50",
    footer: "10 min hop. Allow extra slack in case the Vágatunnilin has morning traffic. Bus stop is at the village centre, 2 min walk from Hugo.",
  },
  {
    num: 2,
    title: "Atlantic Airways RC 416",
    subtitle: "Vágar → London Gatwick",
    middleLabel: "Departs",
    ...
    rightLabel: "Flight",
    rightValue: "2h 15m",
    footer: "The morning the Faroes make you leave. Single terminal — check-in desks open 07:10. Café airside for coffee before the flight. The Forth bridges from the air on descent.",
  },
  {
    num: 3,
    title: "Gatwick · arrivals",
    subtitle: "North Terminal · UK border",
    middleLabel: "Land",
    middleValue: "11:25",
    rightLabel: "Clear",
    rightValue: "~30 min",
    footer: "UK passport e-gates usually fast. Collect bags if checked. Follow signs to South Terminal for National Express coach station.",
  },
  {
    num: 4,
    title: "National Express · LGW → STN",
    subtitle: "Gatwick South → Stansted Airport",
    middleLabel: "Departs",
    middleValue: "~13:00",
    ...
    rightLabel: "Coach",
    rightValue: "~2h 15m",
    footer: "Self-transfer done on purpose. Book in advance at nationalexpress.com. Coach station is at Gatwick South Terminal (free shuttle from North). Allow 4h+ total margin for the LGW→STN transfer.",
  },
  {
    num: 5,
    title: "Stansted Airport",
    subtitle: "Ryanair · RK 330 to Glasgow",
    middleLabel: "Arrive",
    middleValue: "~15:15",
    rightLabel: "Check-in",
    rightValue: "By 17:35",
    footer: "Plenty of time — ~4h before the Glasgow flight. Food court, Wetherspoons airside. Ryanair check-in opens 2h before departure.",
  },
  {
    num: 6,
    title: "Ryanair RK 330",
    subtitle: "Stansted → Glasgow",
    middleLabel: "Departs",
    middleValue: "19:35",
    middleLabel2: "Lands",
    middleValue2: "21:10",
    rightLabel: "Flight",
    rightValue: "1h 35m",
    footer: "Last leg. Glasgow's lights coming up the horizon. The journey ends where it started — Bellshill is 30 min from the airport.",
  },
];
...
function formatSymbol(code: string): string {
  const map: Record<string, string> = {
    ...
    rainshowers_day: "Rain showers", rain: "Rain", lightrain: "Light rain", fog: "Fog",
  };
...
function TripStatusPanel() {
  ...
  return (
    <div className="border border-basalt/15 p-5">
      ...
      <p className="text-[11px] text-basalt/50">RC 416 at 09:10 · RK 330 at 19:35</p>
...
function MobileDecisionPanel() {
  return (
    <div className="border border-basalt/15 rounded-[8px] p-4">
      <p className="text-[10px] uppercase tracking-[0.12em] text-fjord/60">Homeward</p>
      <p className="code tnum text-[36px] font-medium text-basalt leading-none mt-1">RC 416 · 09:10</p>
      <p className="text-[13px] text-basalt/65 mt-2">
        Bus to Vágar Airport. <strong>RC 416 to Gatwick</strong>, National Express coach to Stansted,
        then <strong>RK 330 to Glasgow</strong> at 19:35. Home by ~22:00.
      </p>
      <div className="flex gap-6 mt-3 pt-3 border-t border-basalt/10">
        <div><p className="text-[10px] uppercase tracking-[0.1em] text-basalt/45">Flights</p><p className="code tnum text-[15px] font-medium text-basalt">2 legs</p></div>
    ...
    <>
      ...
      <article className="hidden lg:grid grid-cols-[1fr_340px] gap-8 px-8 pt-8 pb-20 max-w-[1280px]">
        <div className="min-w-0">
          <div className="mb-8">
            ...
            <p className="text-[20px] font-medium text-basalt/80 mt-2">Sørvágur → Gatwick → Stansted → Glasgow</p>
          ...
          <section className="mb-10">
            <p className="text-[10px] uppercase tracking-[0.16em] text-fjord/60 mb-4">Homeward journey</p>
            <Timeline />
          </section>
          ...
          <section className="max-w-[48rem]">
            <div className="harbour-notice">
              ...
              <p className="text-[14px]">
                Faroese fog swallows the morning flight more often than you'd like. Build slack into the LGW→STN transfer for that reason too. If RC 416 is delayed, the National Express coach is rebookable — don't panic, just move to the next one.
              </p>
            </div>
          </section>
        </div>
      ...
      <article className="lg:hidden px-4 pt-6 pb-24 max-w-[640px] mx-auto">
        ...
        <section className="mb-8">
          <p className="text-[10px] uppercase tracking-[0.16em] text-fjord/60 mb-3">Homeward journey</p>
          <div className="space-y-2.5">
            {DAY_FIVE_TIMELINE.map((step) => (
