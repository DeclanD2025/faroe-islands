  ...
  return (
    <>
      ...
      <article className="lg:hidden px-4 pt-6 pb-24 max-w-[640px] mx-auto">
        <div className="mb-6"><p className="text-[11px] tracking-[0.14em] uppercase text-rust font-medium">Day 5 · Saturday · 1 August</p><h1 className="text-[clamp(2rem,8vw,2.6rem)] leading-[1.06] mt-1 text-basalt tracking-[-0.01em]" style={{ fontFamily: "var(--font-cinzel)" }}>Homeward</h1><p className="text-[17px] font-medium text-basalt/80 mt-1.5">Sørvágur → Gatwick → Stansted → Glasgow</p><p className="text-[14px] text-basalt/60 mt-2">Two flights, one coach, and Glasgow's lights at the end — ~15 hours door to door.</p></div>
