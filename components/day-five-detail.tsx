// =============================================================================
// DayFiveDetail — "Repositioning north" page.
// =============================================================================
    ...
    <>
      ...
      <article className="hidden lg:grid grid-cols-[1fr_340px] gap-8 px-8 pt-8 pb-20 max-w-[1280px]">
        <div className="min-w-0">
          ...
          <section className="mb-8"><SummaryStrip items={DAY_FIVE_SUMMARY} /></section>
          <section className="mb-10"><p className="text-[10px] uppercase tracking-[0.16em] text-fjord/60 mb-4">Journey north</p><JourneyTimeline steps={DAY_FIVE_TIMELINE} /></section>
      ...
      <article className="lg:hidden px-4 pt-6 pb-24 max-w-[640px] mx-auto">
        <div className="mb-6">            <p className="text-[11px] tracking-[0.14em] uppercase text-rust font-medium">Day 5 · Friday · 31 July</p><h1 className="text-[clamp(2rem,8vw,2.6rem)] leading-[1.06] mt-1 text-basalt tracking-[-0.01em]" style={{ fontFamily: "var(--font-cinzel)" }}>Repositioning north</h1><p className="text-[17px] font-medium text-basalt/80 mt-1.5">Øravík → Tórshavn → Sørvágur</p><p className="text-[14px] text-basalt/60 mt-2">Last ferry crossing, Bus 300 to Sørvágur, Guesthouse Hugo ten minutes from the terminal.</p></div>
        ...
        <section className="mb-8"><p className="text-[10px] uppercase tracking-[0.16em] text-fjord/60 mb-3">Journey north</p><MobileTimeline steps={DAY_FIVE_TIMELINE} /></section>
